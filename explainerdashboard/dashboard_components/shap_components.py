...
class InteractionSummaryComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        name=None,
        subtitle="Variables ordered by shap interaction",
        hide_title=False,
        hide_subtitle=False,
        hide_col=False,
        hide_depth=False,
...
class InteractionDependenceComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        name=None,
        subtitle="Relation between variable and shap interaction",
        hide_title=False,
        hide_subtitle=False,
        hide_col=False,
...
class ShapContributionsGraphComponent(ExplainerComponent):
    ...
    def __init__(
        ...
        title="Contributions",
        name=None,
        subtitle="Decomposition of each KPI contribution to the prediction",
        hide_title=False,
        hide_subtitle=False,
        hide_index=False,
        hide_depth=False,
