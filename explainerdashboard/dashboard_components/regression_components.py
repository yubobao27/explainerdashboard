...
class RegressionModelSummaryComponent(ExplainerComponent):
    def __init__(
        ...
        title="Evaluation",
        name=None,
        subtitle="Evaluation metrics for model performance",
        hide_title=False,
        hide_subtitle=False,
        round=3,
        show_metrics=None,
...
class RegressionVsColComponent(ExplainerComponent):
    ...
    def __init__(
        self,
        explainer,
        title="residual vs feature",
        name=None,
        subtitle="predictions and residuals variable correlations",
        hide_title=False,
        hide_subtitle=False,
        hide_footer=False,
        hide_col=False,
